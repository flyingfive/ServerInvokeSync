...
{
    public sealed class SockConfig : ConfigurationSection
    {
        public static SockConfig GetConfig()
        {
            return GetConfig("SockConfig");
        }

        public static SockConfig GetConfig(string sectionName)
        {
            var section = (SockConfig)ConfigurationManager.GetSection(sectionName);
            if (section == null)
                return new SockConfig();
            return section;
        }
